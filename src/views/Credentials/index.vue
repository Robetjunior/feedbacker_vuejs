    ...
    <div class="flex flex-col items-center justify-center h-64 bg-brand-gray">
     ...
     <div class="flex justify-center w-full h-full">
      <div class="flex flex-col w-4/5 max-w-6xl py-10">
        ...
        <div
          v-else
          class="flex py-3 pl-5 pr-5 mt-2 roudend justify-between items-center bg-brand-gray w-full lg:w-1/2"
        >
        ...
        >
          ...
          <pre v-else>&lt;script src="https://Robetjunior-feedbacker-widget.netlify.app?apiKey={{store.User.currentUser.apiKey}}"&gt;&lt;/script&gt;</pre>
        </div>
      </div>
    </div>
  </div>
